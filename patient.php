	...
	<div id="tooplate_top">
    	<div id="tooplate_menu" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="patient.php" class="selected">Patient</a></li>
            </ul>
            <br style="clear: left" />
        </div> <!-- end of menu -->
...
<div id="tooplate_header_wrapper">
	<div id="tooplate_header">
        ...
        <div id="slider_wrapper"><center><br/><br/><br/>
               <form name="f1" method="post" action="patientlogin1.php" align="center">
        ...
        <form name="f1" method="post" action="login1.php" align="center">
            <table cellspacing="10px;" align="center">
                <tr><td>Username:</td><td><input type="text" name="name" placeholder="Username" required></td></tr>
                <tr><td>ID:</td><td><input type="text" name="pid" placeholder="Patient ID" required> </td></tr>
