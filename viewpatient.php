...
<div id="tooplate_header_wrapper">
	<div id="tooplate_header">
        ...
        $query="select * from tbl_patient where doc='{$_SESSION['id']}'";
        ...
        <table align="center" border="2" cellspacing="2" cellpadding="2">
            ...
            <tr>
                 ...
                 <td align="center"> <a href="editpat.php?r=<?php echo "{$row['id']}" ?>"> edit </a></td>
                 <td align="center"> <a href="deletepat.php?r=<?php echo "{$row['id']}" ?>"> delete </a></td>
            </tr>
       <?php }?>
        </table> 
