...
<div id="tooplate_header_wrapper">
    <div id="tooplate_header">
      ...
      <div id="site_title"> <h2><a href="index.php">LABORATORY</a></h2> </div>
  <?php 
        session_start();
        if($_SESSION['id']=="")
        {
        ...
        ?>
        <h5 align="right"> Welcome <?php echo $a; ?> to <?php echo $l; ?> lab </h5> <center>
...
<h2>View Requests </h2>
        ...
        //$query="select * from tbl_casepaper where lab='$l' ";
        $query="select DISTINCT(patientid) from tbl_casepaper where lab='$l' and status='pending' ";
        ...
        <table align="center" border="2" width="50%">
            ...
            while($row=mysql_fetch_assoc($result))
            {
                ...
                $query1="select * from tbl_patient where id='$pid' ";
  ...
  <td><?php echo "{$row['patientid']}"?></td>
                 ...
                 <td><a href="dotest.php?r=<?php echo "{$row['patientid']}"?>"> View </a> </td>
